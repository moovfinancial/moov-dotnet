...
namespace Moov.Sdk
{
    ...
    public interface IBranding
    {
        ...
        /// </summary>
        Task<CreateBrandResponse> CreateAsync(string accountID, BrandProperties body, string? xMoovVersion = null, CancellationToken? cancellationToken = null);
        ...
        /// you&apos;ll need to specify the `/accounts/{accountID}/branding.write` scope.
        /// </summary>
        Task<UpsertBrandResponse> UpsertAsync(string accountID, BrandProperties body, string? xMoovVersion = null, CancellationToken? cancellationToken = null);
        ...
        /// </summary>
        Task<GetBrandResponse> GetAsync(string accountID, string? xMoovVersion = null, CancellationToken? cancellationToken = null);

        /// <summary>
        /// Updates the brand properties for the specified account.<br/>
        /// <br/>
        /// To access this endpoint using an <a href="https://docs.moov.io/api/authentication/access-tokens/">access token</a> <br/>
        /// you&apos;ll need to specify the `/accounts/{accountID}/branding.write` scope.
        /// </summary>
        Task<UpdateBrandResponse> UpdateAsync(string accountID, UpdateBrand body, string? xMoovVersion = null, CancellationToken? cancellationToken = null);
    }
    ...
    public class Branding: IBranding
    {
        ...
        public async Task<CreateBrandResponse> CreateAsync(string accountID, BrandProperties body, string? xMoovVersion = null, CancellationToken? cancellationToken = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/accounts/{accountID}/branding", request);
        ...
        public async Task<UpdateBrandResponse> UpdateAsync(string accountID, UpdateBrand body, string? xMoovVersion = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "updateBrand", null, SDKConfiguration.SecuritySource, cancellationToken);
