...
namespace Moov
{
    ...
    public class MoovClient: IMoovClient
    {
        ...
        public MoovClient(Moov.Models.Components.Security? security = null, Func<Moov.Models.Components.Security>? securitySource = null, string? xMoovVersion = null, int? serverIndex = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, IMoovClientHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            if (serverIndex != null)
            {
            ...
            Func<Moov.Models.Components.Security>? _securitySource = null;
        ...
        public class SDKBuilder
        {
            ...
            public SDKBuilder WithSecuritySource(Func<Moov.Models.Components.Security> securitySource)
            {
                _sdkConfig.SecuritySource = securitySource;
                return this;
            }

            public SDKBuilder WithSecurity(Moov.Models.Components.Security security)
            {
