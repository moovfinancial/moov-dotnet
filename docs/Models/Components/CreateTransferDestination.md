...
| `WireDetails`                                                                             | [CreateTransferDestinationWire](../../Models/Components/CreateTransferDestinationWire.md) | :heavy_minus_sign:                                                                        | Wire-specific options supplied when creating a transfer.                                  |