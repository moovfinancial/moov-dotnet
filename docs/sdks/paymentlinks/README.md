...
var res = await sdk.PaymentLinks.CreateAsync(
    ...
    body: new CreatePaymentLink() {
        ...
        CustomAmountPayment = new PaymentLinkCustomAmountPaymentDetails() {
            ...
            AmountRange = new AmountDecimalRange() {
                Minimum = new AmountDecimal() {
                    Currency = "USD",
                    ValueDecimal = "0.00",
                },
                Maximum = new AmountDecimal() {
                    Currency = "USD",
                    ValueDecimal = "1000.00",
                },
            },
            SuggestedAmounts = new List<AmountDecimal>() {
                new AmountDecimal() {
                    Currency = "USD",
                    ValueDecimal = "50.00",
                },
...
| `AccountID`                                                                                                                                                                                  | *string*                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                           | The merchant account ID.                                                                                                                                                                     |                                                                                                                                                                                              |
| `PaymentLinkCode`                                                                                                                                                                            | *string*                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                           | N/A                                                                                                                                                                                          | uc7ZYKrMhi                                                                                                                                                                                   |
| `Body`                                                                                                                                                                                       | [UpdatePaymentLink](../../Models/Components/UpdatePaymentLink.md)                                                                                                                            | :heavy_check_mark:                                                                                                                                                                           | N/A                                                                                                                                                                                          | {<br/>"amount": {<br/>"currency": "USD",<br/>"value": 12099<br/>},<br/>"amountDetails": {<br/>"tax": {<br/>"currency": "USD",<br/>"valueDecimal": "9.25"<br/>}<br/>},<br/>"customer": {<br/>"requirePhone": true,<br/>"requireAddress": true<br/>}<br/>} |
