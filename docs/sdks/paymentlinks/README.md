...
var res = await sdk.PaymentLinks.CreateAsync(
    ...
    body: new CreatePaymentLink() {
        ...
        Payout = new PaymentLinkPayoutDetails() {
            AllowedMethods = new List<DisbursementPaymentMethodType>() {
                DisbursementPaymentMethodType.PushToCard,
                DisbursementPaymentMethodType.PushToApplePay,
                DisbursementPaymentMethodType.RtpCredit,
                DisbursementPaymentMethodType.AchCreditStandard,
            },
            Recipient = new PayoutRecipient() {
                Email = "jordan@example.com",
            },
            PushOptions = new PushOptions() {
                AllowedSpeeds = new List<PushDeliverySpeed>() {
                    PushDeliverySpeed.Instant,
                    PushDeliverySpeed.Deferred,
                },
                DeferredBy = "24h",
            },
            FeePaidBy = new Dictionary<string, FeePaidBy>() {
                { "instant-push-to-card", FeePaidBy.Destination },
                { "deferred-push-to-card", FeePaidBy.Source },
                { "instant-push-to-apple-pay", FeePaidBy.Destination },
                { "rtp-credit", FeePaidBy.Destination },
            },
        },
    }
);
...
var res = await sdk.PaymentLinks.UpdateAsync(
    ...
    body: new UpdatePaymentLink() {
        ...
        Payout = new PaymentLinkPayoutDetailsUpdate() {
            AllowedMethods = new List<DisbursementPaymentMethodType>() {
                DisbursementPaymentMethodType.PushToCard,
                DisbursementPaymentMethodType.RtpCredit,
            },
